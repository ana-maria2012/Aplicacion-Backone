//parametro que permite hacer mas estricto mostrar los errores
'use strict';
...
Express.config = {
  ...
  getAuthorizationUrl: function() {
    //console.log("https://instagram.com/oauth/authorize/?client_id=" + this.clientId + "&redirect_uri=" + this.getRedirectUrl() + "&response_type=token");
...
jQuery(function($) {
  ...
  var Router = Backbone.Router.extend({
    ...
    index: function(hash) {
      console.log(Express.storage.getAccessToken());
